...
@font-face {
    ...
    src: url('@/assets/fonts/Ping/PingAR+LT-Regular.otf') format('opentype');
    font-weight: 400;
    /* font-style: normal; */
  }
  ...
  @font-face {
    ...
    src: url('@/assets/fonts/Ping/PingAR+LT-Bold.otf') format('opentype');
    /* font-weight: 800; */
    /* font-style: normal; */
  }
  ...
  @font-face {
    ...
    src: url('@/assets/fonts/Ping/PingAR+LT-Medium.otf') format('opentype');
    /* font-weight: 900; */
    /* font-style: normal; */
  }
  ...
  @font-face {
    ...
    src: url('@/assets/fonts/Ping/PingAR+LT-Heavy.otf') format('opentype');
    /* font-weight: 900; */
    /* font-style: normal; */
  }
